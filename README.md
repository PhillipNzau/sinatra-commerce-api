...
[fork link]: https://github.com/PhillipNzau/sinatra-commerce-api

The `app/controllers/app_controller.rb` file has an example GET route
...
[frontend-app]: https://github.com/PhillipNzau/electro-commerce
